<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminUsers.aspx.cs" Inherits="StechAcademy.AdminUsers" %>
    ...
    <div class="container" id="UsersTable" runat="server">
        <div class="row">
            <div class="col-lg-offset-4 col-lg-4 ">
                ...
                <br/>
                    <br /><br />
                <asp:GridView ID="GVUsers" CssClass="table table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="userid" OnPageIndexChanging="GVUsers_PageIndexChanging" OnRowCommand="GVUsers_RowCommand" OnRowDeleting="GVUsers_RowDeleting" OnRowEditing="GVUsers_RowEditing"  >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                <asp:LinkButton CssClass="btn" ID="lnkView" runat="server" ToolTip="View Record" CommandArgument='<%# Eval("userid") %>' CommandName="Edit" Text="&lt;i class=&quot;glyphicon glyphicon-pencil btn btn-sm btn-primary&quot;&gt;&lt;/i&gt;"></asp:LinkButton>

                                <asp:LinkButton CssClass="btn" ID="lnkDelete" ToolTip="Delete Record" OnClientClick="return confirm('Are you sure you want to delete this record');" runat="server" CommandArgument='<%# Eval("userid") %>' CommandName="Delete" Text="Delete"><i class="glyphicon glyphicon-trash btn btn-sm btn-danger" ></i></asp:LinkButton>
                                </center>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
